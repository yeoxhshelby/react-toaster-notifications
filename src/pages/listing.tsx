          ...
          <Box width={2 / 3}>
            ...
            <Box>
              <Typography>
                ...
                venenatis sit amet dapibus a, facilisis sed felis. Sed blandit
                orci facilisis volutpat dapibus. Pellentesque non sapien erat.
                Sed vitae dictum justo. Mauris vitae elementum ante, nec
                vulputate eros. Ut blandit eros ligula, nec ullamcorper sapien
                volutpat vel.
              </Typography>
            </Box>
            <Typography sx={{ fontSize: 25, fontWeight: "bold", marginTop: 2 }}>
